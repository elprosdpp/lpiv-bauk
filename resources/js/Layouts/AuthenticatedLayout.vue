                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :active="route().current('updateProfil.index')"
                                         :href="route('updateProfil.index')">
                                    Update Profil
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative flex">
                                <img :src="`/storage/`+ $page.props.auth.user.image_profile" alt="" class="w-8 object-cover rounded-full">
