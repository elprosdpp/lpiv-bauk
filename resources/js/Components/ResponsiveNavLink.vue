...
const classes = computed(() =>
    props.active
        ? 'text-base font-bold text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-100 dark:hover:bg-gray-700 '
