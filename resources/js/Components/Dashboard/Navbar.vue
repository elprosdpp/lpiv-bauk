        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a class="flex ml-2 md:mr-24" href="https://flowbite-admin-dashboard.vercel.app/">
                ...
                <div class="flex items-center">
                    ...
                    <div
                        ...
                        style="position: absolute; inset:0 auto auto 0; margin: 0; transform: translate(2379px, 65px);">
                        <div
                        ...
                        <a class="block py-2 text-base font-normal text-center text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:hover:underline"
                           href="#">
                    ...
                    <div
                        ...
                        data-popper-placement="bottom"
                        style="position: absolute; inset: 0 auto auto 0; margin: 0; transform: translate(2419px, 65px);">
                        <div
                            class="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            Apps
                        </div>
                        <div class="grid grid-cols-3 gap-4 p-4">
                            <a class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600"
                               href="#">
                    ...
                    <div id="tooltip-toggle"
                         ...
                         data-popper-placement="bottom"
                         role="tooltip"
                         style="position: absolute; inset: 0 auto auto 0; margin: 0; transform: translate(2387px, 63px);">
                        Toggle dark mode
                        <div class="tooltip-arrow" data-popper-arrow=""
                             style="position: absolute; left: 0; transform: translate(69px, 0px);"></div>
                    </div>

                    <div class="flex items-center ml-3">
                        <div>
                            <button id="user-menu-button-2"
                                    aria-expanded="false"
                                    class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                                    data-dropdown-toggle="dropdown-2" type="button">
                                <span class="sr-only">Open user menu</span>
                                <img :src="`/storage/`+ $page.props.auth.user.image_profile"
                                     alt="user photo"
                        ...
                        <div
                            ...
                            data-popper-placement="bottom"
                            style="position: absolute; inset: 0 auto auto 0; margin: 0; transform: translate(2507px, 61px);">
