                        ...
                        <ul class="pb-2 space-y-2">
                            ...
                            <li>
                                ...
                                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                                    <li>
                                        <a class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                                           href="#">Products</a>
                                    </li>
                                    <li>
                                        <a class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                            ...
                            <li>
                                <button aria-controls="dropdown-crud"
                                ...
                                <ul id="dropdown-crud" class="space-y-2 py-2 hidden ">
                                    <li>
                                        <a class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 "
                                           href="https://flowbite-admin-dashboard.vercel.app/crud/products/">Products</a>
                                    </li>
                                    <li>
                                        <a class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 "
                                           href="https://flowbite-admin-dashboard.vercel.app/crud/users/">Users</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/pages/pricing/">Pricing</a>
                                    </li>
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/pages/maintenance/">Maintenance</a>
                                    </li>
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/pages/404/">404
                                            not found</a>
                                    </li>
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/pages/500/">500
                                            server error</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <button aria-controls="dropdown-auth"
                                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                        data-collapse-toggle="dropdown-auth" type="button">
                                    <svg
                                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path clip-rule="evenodd"
                                ...
                                <ul id="dropdown-auth" class="hidden py-2 space-y-2">
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/authentication/sign-in/">Sign
                                            in</a>
                                    </li>
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/authentication/sign-up/">Sign
                                            up</a>
                                    </li>
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/authentication/forgot-password/">Forgot
                                            password</a>
                                    </li>
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/authentication/reset-password/">Reset
                                            password</a>
                                    </li>
                                    <li>
                                        <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                           href="https://flowbite-admin-dashboard.vercel.app/authentication/profile-lock/">Profile
                                            lock</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <button aria-controls="dropdown-playground"
                                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                        data-collapse-toggle="dropdown-playground" type="button">
                                    <svg
                                        aria-hidden="true"
                                        class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                        fill="currentColor" viewBox="0 0 20 20"
                                ...
                                <ul id="dropdown-playground" class="space-y-2 py-2 hidden ">
                                    <li>
                                        <a class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 "
                                           href="https://flowbite-admin-dashboard.vercel.app/playground/stacked/">Stacked</a>
                                    </li>
                                    <li>
                                        <a class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 "
                                           href="https://flowbite-admin-dashboard.vercel.app/playground/sidebar/">Sidebar</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        <div class="pt-2 space-y-2">
                            <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700"
                               href="https://github.com/themesberg/flowbite-admin-dashboard"
                               target="_blank">
                                <svg aria-hidden="true"
                                     class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                     fill="currentColor" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
                                    <path
