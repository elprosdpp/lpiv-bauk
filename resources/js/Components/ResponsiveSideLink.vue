...
const classes = computed(() =>
    props.active
        ? 'text-base font-bold text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 dark:text-gray-100 dark:hover:bg-gray-700 '
        : 'text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 dark:text-gray-200 dark:hover:bg-gray-700 '
);
</script>
