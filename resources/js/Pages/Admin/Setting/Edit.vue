...
const form = useForm({
    user_id: user.id,
    ip_address_router: props.setting.ip_address_router,
    username_router: props.setting.username_router,
    password_router: props.setting.password_router,
});


// function settingUpdate() {
//     router.post(route(`/admin/setting/${props.setting.id}/edit`), {
//         _method: 'put',
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-2">
                    <div class="overflow-hidden shadow-sm sm:rounded-lg">
                        <form class="flex flex-col gap-2 mt-10"
                              @submit.prevent="form.put(route('setting.update', props.setting.id))">
                            <div class="w-1/2">
