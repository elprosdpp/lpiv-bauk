                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th class="py-3 px-6" scope="col">Category</th>
                            <th class="py-3 px-6" scope="col">Tags</th>
...
<!--                                <span v-html="post.description"></span>-->
                            ...
                            <td class="flex flex-wrap py-4 px-6 max-w-2xl" data-label="Title">
                                <div v-for="(p, index) in post.tags.split(',')" :key="index"
                                     class="flex flex-wrap">
                                    <span
                                        class="bg-blue-100 mb-2 text-blue-800 text-xs font-medium mr-1 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ">{{p}}</span>
                                </div>
                            </td>
                            <td
