                ...
                <div class="overflow-hidden sm:rounded-lg">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="relative">
                            ...
                            <input v-model="search" class="block w-full p-3 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-2">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        <tr v-for="role in props.roles.data" :key="role.role_id"
                                        ...
                                        <div class="relative bg-white rounded-lg dark:bg-gray-700">
                                            ...
                                            <div class="px-6 py-6 lg:px-10 lg:pb-20">
                                                ...
                                                <form class="space-y-6"
                                                    ...
                                                    <InputLabel class="-mb-6" for="permission" value="Permission Add"/>
                                                    <multiselect
